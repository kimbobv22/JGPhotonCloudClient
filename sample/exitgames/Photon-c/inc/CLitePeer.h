...
extern "C"
{
	...
	bool LitePeer_opRaiseEvent(SPhotonPeer* pPeer, bool sendReliable, EG_HashTable* evData, nByte eventCode, nByte channelId, int* targetActors, short numTargetActors, nByte eventCaching, nByte receiverGroup);
	...
	// internals
	bool LitePeer_internal_opRaiseEvent(SPhotonPeer* pPeer, bool sendReliable, EG_HashTable* evData, nByte eventCode, nByte channelId, int* targetActors, short numTargetActors, nByte eventCaching, nByte receiverGroup, bool copy);
