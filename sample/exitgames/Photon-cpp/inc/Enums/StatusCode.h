...
#ifndef __PHOTON_STATUS_CODE_H
#define __PHOTON_STATUS_CODE_H
...
namespace ExitGames
{
	namespace Photon
	{
		namespace StatusCode
		{
			...
			static const int QUEUE_SENT_WARNING                = 1037; // PhotonPeer sent queue is filling up. Check, why the server does not acknowldge your sent reliable commands.
