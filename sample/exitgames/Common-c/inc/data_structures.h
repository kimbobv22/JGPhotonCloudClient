...
/**
This file contains the helper functions for
...
details.                                               */
	...
	/* <title EG_Object structure>
	   ...
	   * ------------- --------------- *
	   ...
	   \1. Use EG_Object_create()
	   to create EG_Objects holding non-array data.
	   
	   \2. Use EG_Object_createFromArray()
	   for creating objects holding single-dimensional arrays
	   
	   \2. Use EG_Object_createFromMultiDimensionalArray()
	   ...
	   @sa
	   <link MemoryManagement, Sending and receiving data> , EG_Object_create()
	   , EG_Object_createFromArray()
	   , EG_Object_createFromMultiDimensionalArray(),
	   EG_Object_delete() , EG_Object_compare()               */
	...
	/* <title EG_Vector structure>
	   ...
	   @sa
	   EG_Object , EG_Vector_getLastIndex()
	   , EG_Vector_getLastElement()
	   , EG_Vector_release() ,
	   EG_Vector_initialize()                        */
	...
	/* <title EG_HashTable structure>
	   ...
	   @sa
	   EG_Object , EG_HashTable_initialize()
	   , EG_HashTable_addEntry()
	   , EG_HashTable_removeEntry()
	   , EG_HashTable_clear()
	   , EG_HashTable_toString()                       */
	...
	typedef struct _EG_Dictionary
	{
		EG_HashTable entries;
		nByte* keyTypes;
		nByte* valueTypes;
		unsigned int* valueArrayDimensions;
	} EG_Dictionary;
		...
		{
	#endif
		void EG_Dictionary_addEntry(EG_Dictionary* dictionary, EG_Object* Key, EG_Object* Val);
		void EG_Dictionary_removeEntry(EG_Dictionary* dictionary, EG_Object* Key);
		void EG_Dictionary_initialize(EG_Dictionary* dictionary, const nByte* keyTypes, const nByte* valueTypes, const unsigned int* valueArrayDimensions);
		void EG_Dictionary_clear(EG_Dictionary* dictionary);
		EG_Object* EG_Dictionary_getValFromKey(EG_Dictionary* dictionary, void* key, nByte keyType, int* hashIndex);
		EG_HashTable* EG_Dictionary_getHashTable(EG_Dictionary* dictionary);
		EG_CHAR* EG_Dictionary_toString(EG_Dictionary* dictionary);
		EG_CHAR* EG_Dictionary_toStringWithTypes(EG_Dictionary* dictionary, bool withTypes);
		nByte* EG_Dictionary_getKeyTypes(EG_Dictionary* dictionary);
		nByte* EG_Dictionary_getValueTypes(EG_Dictionary* dictionary);
		unsigned int* EG_Dictionary_getValueArrayDimensions(EG_Dictionary* dictionary);
		bool EG_Dictionary_compareTypes(EG_Dictionary* dictionary, EG_Object* key, EG_Object* val);
	#ifdef __cplusplus
		}
	#endif
