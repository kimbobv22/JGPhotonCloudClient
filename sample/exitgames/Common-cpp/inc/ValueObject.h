...
namespace ExitGames
{
	namespace Common
	{
		...
		template<typename Etype>
		template<typename Ftype>
		void* ValueObject<Etype>::getDataCopyImplementation<Ftype*>::lastDimension(const void* const pArrayIn, short size) const
		{
